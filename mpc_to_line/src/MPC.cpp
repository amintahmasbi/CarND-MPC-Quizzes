...
size_t a_start = delta_start + N - 1;//For N steps there exit only N-1 actuators (0 is the initial step)
 ...
 public:
  ...
  void operator()(ADvector& fg, const ADvector& vars) {
    ...
    for (int t = 1; t < N; t++) {
      ...
      // TODO: Setup the model constraints
      ...
      fg[1 + epsi_start + t] = epsi1 - (epsi0 + v0 / Lf * delta * dt);
